...
def set_args():
    ...
    parser.add_argument('--model_path', type=str, default="../output_dir/", help='save model dpath')
...
def main():
    ...
    processor = RobertaModel.from_pretrained(opt["roberta_path"])
    model = RobertaClassificationModel_transformer(args)
